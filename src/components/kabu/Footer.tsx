    ...
    <footer className="border-t border-black/5 bg-white py-12">
      <div className="mx-auto max-w-6xl px-5 text-center sm:px-8">
        <div className="flex flex-col items-center gap-2">
          <KabuLogo className="h-10 w-10" />
          <span className="text-base font-bold tracking-tight text-foreground">Kabu</span>
        </div>
        <div className="mt-6 flex justify-center gap-5">
          <a
            href="https://www.instagram.com/kabu.app"
            target="_blank"
          ...
          <a
            href="https://www.tiktok.com/@kabuapp"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="TikTok"
            className="text-kabu-muted transition-colors duration-200 hover:text-foreground"
